import { GameSummaryType, TournamentType } from "@models/records";

const games1: GameSummaryType[] = [
  {
    id: 1,
    date: "2024-04-04",
    time: "11:30",
...
export const sampleGameSummary_win: GameSummaryType = games1[3];

export const sampleGameSummary_draw: GameSummaryType = games1[2];

export const sampleGameSummary_loss: GameSummaryType = games1[0];
