...
class NoticeSimpleSerializer(ModelSerializer):
    ...
    class Meta:
        model = Notice
        fields = [
            'id', 'title', 'category', 'author', 'num_comments',
            'created_at', 'num_views', 'num_likes', 'has_attachment'
        ]
    ...
    def get_num_comments(self, obj):
        return obj.noticecomment_set.filter(is_deleted=False).count()

    def get_num_likes(self, obj):
        return obj.noticelike_set.count()
...
class NoticeDetailSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'num_views', 'comments', 'attachments', 'num_likes', 'is_liked', 'is_author'
        ]
    ...
    def get_is_liked(self, obj):
        ...
        return obj.noticelike_set.filter(user=user).exists()
